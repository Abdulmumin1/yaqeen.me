...
i've built quite a few interesting stuff, most of them i want them or just to learn. but <span data-highlight>what is really cool is that i get to use most of what i build in other stuff i build.</span>
