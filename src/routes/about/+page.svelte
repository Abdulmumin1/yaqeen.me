...
<div class="max-w-2xl mx-auto px-6 py-12 md:py-24 flex flex-col gap-12">
	<div class="flex flex-col gap-8">
		<h1 class="text-3xl font-serif text-stone-900 border-b border-stone-200 pb-2 w-fit pr-8">
			About
		</h1>
		...
		<div class="flex items-center gap-4">
			...
			>
				<span class="profile-frame overflow-hidden rounded-xl border border-stone-200 block shadow-sm group-hover:border-accent transition-colors">
					<img src={me} alt="Abdulmumin Yaqeen" class="w-24 h-24 object-cover grayscale hover:grayscale-0 transition-all duration-500" />
				</span>
				<span
	...
	<div class="flex flex-col gap-6 text-lg font-visby text-stone-700 leading-relaxed max-w-xl">
		<p>I'm <span class="text-stone-900 font-medium">Abdulmumin Yaqeen</span>.</p>
		<p>I do stuff, mostly a developer.</p>
		<p>
			Used to run a <a class="text-stone-900 decoration-accent/30 underline underline-offset-4 hover:decoration-accent transition-colors" href="https://www.youtube.com/@abdulmuminyqn"
				>YouTube channel</a
			> a few years ago.
		</p>
	...
	<div class="flex flex-col gap-8 pt-4">
		<div class="space-y-4">
			<h2 class="text-2xl font-serif text-stone-900">Defaults</h2>
			<ul class="flex flex-col border-t border-stone-200">
				<li class="py-4 text-base text-stone-600 border-b border-stone-100">
